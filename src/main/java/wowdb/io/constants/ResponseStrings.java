package wowdb.io.constants;

public class ResponseStrings {
    public static final String SUCCESS_PROCEED = "Processed successfully";
    public static final String ACCOUNT_DOES_NOT_EXIST = "Account [%s] does not exist";
    public static final String ACCOUNT_LOGIN_ALREADY_EXIST = "The login [%s] already exist";
    public static final String ACCOUNT_EMAIL_ALREADY_IN_USE = "The email [%s] is already in use";
    ...
    public static final String BUILD_P_BANNED_DOES_NOT_EXIST = "Ip banned [%s] - does not exist";
}
